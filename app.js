...
var warning = 3; //times a user can enter incorrect passwords
var userFinder = 0; //index number for user search
...
async function welcomeUser(para) {
...
async function transaction(para) {
    let balance = user[para].amount;
...
async function cashDeposit(para) {
    let balance = user[para].amount;
